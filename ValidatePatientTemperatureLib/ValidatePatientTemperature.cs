...
namespace ValidatePatientTemperatureLib
{
    ...
    public class ValidatePatientTemperature : IValidateVitalSign
    {
        ...
        //This will give alert if temperature goes out of range for patient with id m_patientId
        public string ValidateVitalSign(string m_patientId, string m_vitalSignValue)
        {
            ...
            if (!IsVitalSignInRange(m_temperature))
            {
                ...
                return "Alert!!! Temperature not in range Temperature: " + m_temperature + " for patient " + m_patientId + "";
            }
            return "";
        }
    }
